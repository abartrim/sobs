...
// Code generated from migration/manifest/routes.generated.json. DO NOT EDIT.
// endpoint -> URL rule, used by url_for(). Param routes keep their <...> rule;
// url_for substitutes path params at call time (see urlFor()).
