...
app.py statements: **14884** · covered **11471** (77.07%) · uncovered **3413**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 386 | 11.3% | except-body pass/log/continue — needs fault injection |
...
| COVERABLE | 2982 | 87.4% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 431 lines (12.6% of uncovered).**
