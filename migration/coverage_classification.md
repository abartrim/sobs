...
app.py statements: **14884** · covered **10441** (70.15%) · uncovered **4443**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 388 | 8.7% | except-body pass/log/continue — needs fault injection |
...
| COVERABLE | 4008 | 90.2% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 435 lines (9.8% of uncovered).**
