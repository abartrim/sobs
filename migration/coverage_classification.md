...
app.py statements: **14884** · covered **11681** (78.48%) · uncovered **3203**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 386 | 12.1% | except-body pass/log/continue — needs fault injection |
| NOW_WINDOW | 1 | 0.0% | chdb now() wall-clock — needs now()-anchored seed or unverifiable |
| LIBRARY_ERR_TEXT | 42 | 1.3% | message embeds a Python library exception string (re/json/chdb) — differs Go-vs-Py (F2) |
| COVERABLE | 2774 | 86.6% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 429 lines (13.4% of uncovered).**
