...
app.py statements: **14884** · covered **11864** (79.71%) · uncovered **3020**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 384 | 12.7% | except-body pass/log/continue — needs fault injection |
...
| COVERABLE | 2593 | 85.9% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 427 lines (14.1% of uncovered).**
