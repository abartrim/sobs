...
app.py statements: **14884** · covered **10789** (72.49%) · uncovered **4095**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 386 | 9.4% | except-body pass/log/continue — needs fault injection |
...
| COVERABLE | 3662 | 89.4% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 433 lines (10.6% of uncovered).**
