...
app.py statements: **14884** · covered **11591** (77.88%) · uncovered **3293**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 386 | 11.7% | except-body pass/log/continue — needs fault injection |
...
| COVERABLE | 2862 | 86.9% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 431 lines (13.1% of uncovered).**
