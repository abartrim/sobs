...
app.py statements: **14884** · covered **10166** (68.30%) · uncovered **4718**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 388 | 8.2% | except-body pass/log/continue — needs fault injection |
...
| COVERABLE | 4278 | 90.7% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 440 lines (9.3% of uncovered).**
