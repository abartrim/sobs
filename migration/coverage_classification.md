...
app.py statements: **14884** · covered **10665** (71.65%) · uncovered **4219**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 386 | 9.1% | except-body pass/log/continue — needs fault injection |
...
| COVERABLE | 3786 | 89.7% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 433 lines (10.3% of uncovered).**
