...
app.py statements: **14884** · covered **11269** (75.71%) · uncovered **3615**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 386 | 10.7% | except-body pass/log/continue — needs fault injection |
...
| COVERABLE | 3183 | 88.0% | a byte-parity route can reach it (schedulable) |
