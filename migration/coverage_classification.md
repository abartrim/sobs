...
app.py statements: **14884** · covered **11770** (79.08%) · uncovered **3114**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 386 | 12.4% | except-body pass/log/continue — needs fault injection |
...
| COVERABLE | 2685 | 86.2% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 429 lines (13.8% of uncovered).**
