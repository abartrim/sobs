...
app.py statements: **14884** · covered **10046** (67.50%) · uncovered **4838**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 397 | 8.2% | except-body pass/log/continue — needs fault injection |
...
| COVERABLE | 4389 | 90.7% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 449 lines (9.3% of uncovered).**
