...
app.py statements: **14884** · covered **11696** (78.58%) · uncovered **3188**
...
| COVERABLE | 2759 | 86.5% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 429 lines (13.5% of uncovered).**
