...
app.py statements: **14884** · covered **10021** (67.33%) · uncovered **4863**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 411 | 8.5% | except-body pass/log/continue — needs fault injection |
...
| COVERABLE | 4400 | 90.5% | a byte-parity route can reach it (schedulable) |
