...
app.py statements: **14884** · covered **10309** (69.26%) · uncovered **4575**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 388 | 8.5% | except-body pass/log/continue — needs fault injection |
...
| COVERABLE | 4140 | 90.5% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 435 lines (9.5% of uncovered).**
