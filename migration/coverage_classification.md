...
app.py statements: **14884** · covered **9947** (66.83%) · uncovered **4937**
...
| LIBRARY_ERR_TEXT | 47 | 1.0% | message embeds a Python library exception string (re/json/chdb) — differs Go-vs-Py (F2) |
| COVERABLE | 4472 | 90.6% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 465 lines (9.4% of uncovered).**
