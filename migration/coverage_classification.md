...
app.py statements: **14884** · covered **10230** (68.73%) · uncovered **4654**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 388 | 8.3% | except-body pass/log/continue — needs fault injection |
...
| COVERABLE | 4219 | 90.7% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 435 lines (9.3% of uncovered).**
