...
app.py statements: **14884** · covered **11425** (76.76%) · uncovered **3459**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 386 | 11.2% | except-body pass/log/continue — needs fault injection |
...
| COVERABLE | 3028 | 87.5% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 431 lines (12.5% of uncovered).**
