...
app.py statements: **14884** · covered **11345** (76.22%) · uncovered **3539**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 386 | 10.9% | except-body pass/log/continue — needs fault injection |
...
| COVERABLE | 3108 | 87.8% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 431 lines (12.2% of uncovered).**
