...
app.py statements: **14884** · covered **10110** (67.93%) · uncovered **4774**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 388 | 8.1% | except-body pass/log/continue — needs fault injection |
...
| COVERABLE | 4334 | 90.8% | a byte-parity route can reach it (schedulable) |
