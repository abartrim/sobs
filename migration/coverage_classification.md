...
app.py statements: **14884** · covered **11120** (74.71%) · uncovered **3764**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 386 | 10.3% | except-body pass/log/continue — needs fault injection |
...
| COVERABLE | 3332 | 88.5% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 432 lines (11.5% of uncovered).**
