...
app.py statements: **14884** · covered **11509** (77.32%) · uncovered **3375**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 386 | 11.4% | except-body pass/log/continue — needs fault injection |
...
| COVERABLE | 2944 | 87.2% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 431 lines (12.8% of uncovered).**
