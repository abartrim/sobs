...
app.py statements: **14884** · covered **11804** (79.31%) · uncovered **3080**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 384 | 12.5% | except-body pass/log/continue — needs fault injection |
| NOW_WINDOW | 1 | 0.0% | chdb now() wall-clock — needs now()-anchored seed or unverifiable |
| LIBRARY_ERR_TEXT | 42 | 1.4% | message embeds a Python library exception string (re/json/chdb) — differs Go-vs-Py (F2) |
| COVERABLE | 2653 | 86.1% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 427 lines (13.9% of uncovered).**
