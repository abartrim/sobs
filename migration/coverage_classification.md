...
app.py statements: **14884** · covered **10524** (70.71%) · uncovered **4360**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 388 | 8.9% | except-body pass/log/continue — needs fault injection |
| NOW_WINDOW | 2 | 0.0% | chdb now() wall-clock — needs now()-anchored seed or unverifiable |
| LIBRARY_ERR_TEXT | 45 | 1.0% | message embeds a Python library exception string (re/json/chdb) — differs Go-vs-Py (F2) |
| COVERABLE | 3925 | 90.0% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 435 lines (10.0% of uncovered).**
