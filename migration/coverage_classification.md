...
app.py statements: **14884** · covered **11636** (78.18%) · uncovered **3248**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 386 | 11.9% | except-body pass/log/continue — needs fault injection |
| NOW_WINDOW | 1 | 0.0% | chdb now() wall-clock — needs now()-anchored seed or unverifiable |
| LIBRARY_ERR_TEXT | 44 | 1.4% | message embeds a Python library exception string (re/json/chdb) — differs Go-vs-Py (F2) |
| COVERABLE | 2817 | 86.7% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 431 lines (13.3% of uncovered).**
