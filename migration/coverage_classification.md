...
app.py statements: **14884** · covered **10060** (67.59%) · uncovered **4824**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 390 | 8.1% | except-body pass/log/continue — needs fault injection |
...
| COVERABLE | 4382 | 90.8% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 442 lines (9.2% of uncovered).**
