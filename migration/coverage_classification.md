...
app.py statements: **14884** · covered **10025** (67.35%) · uncovered **4859**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 403 | 8.3% | except-body pass/log/continue — needs fault injection |
...
| COVERABLE | 4404 | 90.6% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 455 lines (9.4% of uncovered).**
