...
app.py statements: **14884** · covered **10364** (69.63%) · uncovered **4520**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 388 | 8.6% | except-body pass/log/continue — needs fault injection |
...
| COVERABLE | 4085 | 90.4% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 435 lines (9.6% of uncovered).**
