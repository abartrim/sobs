...
app.py statements: **14884** · covered **10614** (71.31%) · uncovered **4270**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 388 | 9.1% | except-body pass/log/continue — needs fault injection |
| NOW_WINDOW | 2 | 0.0% | chdb now() wall-clock — needs now()-anchored seed or unverifiable |
| LIBRARY_ERR_TEXT | 45 | 1.1% | message embeds a Python library exception string (re/json/chdb) — differs Go-vs-Py (F2) |
| COVERABLE | 3835 | 89.8% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 435 lines (10.2% of uncovered).**
