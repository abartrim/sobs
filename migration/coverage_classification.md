...
app.py statements: **14884** · covered **10894** (73.19%) · uncovered **3990**
...
|---|---:|---:|---|
| DEFENSIVE_EXCEPT | 386 | 9.7% | except-body pass/log/continue — needs fault injection |
...
| COVERABLE | 3558 | 89.2% | a byte-parity route can reach it (schedulable) |

**Structurally-deferred (lower bound): 432 lines (10.8% of uncovered).**
